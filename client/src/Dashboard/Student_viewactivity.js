...
import { Container, Grid, Typography, Box, Divider, TextField, InputAdornment, IconButton, Button, Avatar } from "@mui/material";
...
const data = [
    {
        ...
        Message: "Lezzzzzzzgo Lezzzzzzzgo Lezzzzzzzgo Lezzzzzzzgo Lezzzzzzzgo Lezzzzzzzgo Lezzzzzzzgo Lezzzzzzzgo"
    },
    {
        ...
        <Grid container rowSpacing = {1} columnSpacing = {1}>
            <Grid item xs = {3} sx = {designs.Left_Container_GridItem_Style}>
                ...
                <Box className = "Write-comment" sx = {designs.Write_Comment_Style}>
                    ...
                    <TextField id="filled-basic" placeholder="Write a comment" variant="filled" 
            ...
            <Grid item md = {9} xs = {12} sx = {designs.Right_Container_GridItem_Style}>
                <Box className = "Right-container" sx = {designs.Right_Container_Style}>
                    ...
                    <Box className = "Activity-instructions" sx = {designs.ActivityInstructions_Style}>
                        <Typography sx = {designs.ActivityInstructionsHead_Typography_Style}>
                        ...
                        <Box className = "Activity-filename" sx={designs.ActivityFileName_Style}>
                            <Typography noWrap sx = {designs.ActivityFileName_Typography_Style}>
                            ACTIVITY 5.docx
                            </Typography>
                ...
                <Box className = "Footer" sx = {designs.Footer_Style}>
                    ...
                    <Button sx={designs.UploadFile_Button_Style} startIcon={<FileUploadOutlined sx = {designs.FileUploadOutlinedIcon_Style}/>}>
                    Upload File
                    </Button>
                    ...
                    <Button sx={designs.Submit_Button_Style}>
                    Submit
                    </Button>
                </Box>
            ...
            <Grid item xs = {12} sx = {designs.Left_Container_GridItem_Responsive_Style}>
                <Box className = "Left-container" sx = {designs.Left_Container_Style}>
                <Typography
                sx = {designs.MessageArea_Typography_Style}>
                Comment Area
