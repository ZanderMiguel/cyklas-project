...
function ExamFormV2() {
  ...
  const [selectAnswerType, setSelectAnswerType] =
    React.useState('Multiple Choice');
    ...
    <Container maxWidth="md" sx={{ padding: '1.5em 0em' }}>
      ...
      >
        ...
        >
          ...
          <Tooltip
            title="Select the answer type for this question"
            placement="top"
          >
            <FormControl
              variant="standard"
        ...
        {selectAnswerType === 'Checkboxes' && <ExamCheckboxesV2 />}
        {selectAnswerType === 'True or False' && <ExamTrueorfalseV2 />}
        {selectAnswerType === 'Short Answer' && <ExamShortanswerV2 />}
      </Grid>
