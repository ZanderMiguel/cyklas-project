...
import useStyle from '../Styles/Student_rankings_style';
    ...
    <Container maxWidth="xl">
      <Grid container sx={designs.GridContainer_Style}>
        <Grid item sm={5} xs={12}>
          <Typography sx={designs.StudentRakings_Typography_Style}>
            Student Rankings
          </Typography>
        </Grid>
        ...
        <Grid item md={8} xs={12}>
          <Box className="Top-students" sx={designs.Top_Students_Style}>
            <Typography sx={designs.Congratulations_Typography_Style}>
              Congratulations!
            </Typography>
            ...
            <Box className="Top3-students" sx={designs.Top3_Students_Style}>
              <Box className="Top2" sx={designs.Top2_Style}>
                ...
                <Typography sx={designs.TopStudentName_Typography_Style}>
                  Tom Holland
                </Typography>
                ...
                <Box className="Place" sx={designs.Place_Style}>
                  ...
                  <Typography sx={designs.SecondPlace_Typography_Style}>
                    2nd Place
                  </Typography>
                </Box>
              </Box>
              ...
              <Box className="Top1" sx={designs.Top1_Style}>
                ...
                <Box className="Place" sx={designs.Place_Style}>
                  ...
                  <Typography sx={designs.FirstPlace_Typography_Style}>
                    1st Place
                  </Typography>
                </Box>
              </Box>
              ...
              <Box className="Top3" sx={designs.Top3_Style}>
                ...
                <Box className="Place" sx={designs.Place_Style}>
                  ...
                  <Typography sx={designs.ThirdPlace_Typography_Style}>
                    3rd Place
                  </Typography>
                </Box>
              </Box>
            ...
            <Box
              className="Top3-students"
              sx={designs.Responsive_Top3_Students_Style}
            >
        ...
        <Grid item md={4} xs={12} sx={designs.StudentList_GridItem_Style}>
          <Box className="Result" sx={designs.Result_Style}>
            <Box className="Heading" sx={designs.Heading_Style}>
              <Typography sx={designs.StudentName_Typography_Style}>
                Student Name
              </Typography>

              <Box flexGrow={1} sx={designs.StudenList_BoxFlexGrow_Style} />

              <Typography sx={designs.Score_Typography_Style}>Score</Typography>
            </Box>
