...
import {Typography, TextField, InputAdornment, Box, Container, Grid} from "@mui/material";
import { Link } from 'react-router-dom';
import Image from "../../assets/ImageJaven/Image.png";
import { Timer, SportsScore, Star, Layers } from "@mui/icons-material";
import useStyle from './StudentLiveQuiz_multiplechoice_style';
...
function StudentLiveQuiz_multiplechoice() {
    ...
    return (
        ...
        {/* <Container maxWidth = "lg" sx = {{backgroundColor: "#C4B4E5"}}> */}
            <Grid container columnSpacing = {2} sx = {designs.GridContainer1_Style}>
                <Grid item xs = {12} sm = {6} lg = {3}>
                    ...
                    <Box className = "Timer-sub" sx = {designs.QuizStatus_Sub_Style}>
                        <Timer
                        sx = {designs.TimerIcon_Style}/>

                        <Typography noWrap
                        sx = {designs.QuizStatus_Typography_Style}> 
                        Timer
                        </Typography>
                    </Box>
                    <Box className = "Time" sx = {designs.QuizStatus_Sub2_Style}>
                        <Typography noWrap 
                        sx = {designs.QuizStatus_Typography2_Style}> 
                        39 seconds
                        </Typography>
                    </Box>
                    </Box>
                ...
                <Box className = "Score" sx = {designs.QuizStatus_Style}>
                    <Box className = "Score-sub" sx = {designs.QuizStatus_Sub_Style}>
                        <SportsScore
                        sx = {designs.PeopleAltIcon_Style}/>
            ...
            <Grid container columnSpacing = {2} rowSpacing = {1} sx = {designs.GridContainer3_Style}>
            <Grid item xs = {12} sm = {6}>
                <Box className = "Answer-a" onClick = {() => {}} sx = {designs.Answer_A_Style}>
            ...
            <Grid item xs = {12} sm = {6}>
                <Box className = "Answer-b" onClick = {() => {}} sx = {designs.Answer_B_Style}>
                    <Box className = "Quiz-item" sx = {designs.Quiz_Item_Style2}>
            ...
            <Grid container columnSpacing = {2} rowSpacing = {1} sx = {designs.GridContainer4_Style}>
            <Grid item xs = {12} sm = {6}>
                <Box className = "Answer-c" onClick = {() => {}} sx = {designs.Answer_C_Style}>
                    <Box className = "Quiz-item" sx = {designs.Quiz_Item_Style2}>
            ...
            <Grid item xs = {12} sm = {6}>
                <Box className = "Answer-d" onClick = {() => {}} sx = {designs.Answer_D_Style}>
                    <Box className = "Quiz-item" sx = {designs.Quiz_Item_Style2}>
