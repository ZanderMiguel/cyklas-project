...
function PresentationCriteria() {
  const [opendialogApplyScore, setOpenDialogApplyScore] =
    ...
    >
      ...
      <Box sx = {{
        ...
        {dataCriteria.map(function(items, index) {
          ...
          sx = {{
            ...
            sx = {{
              ...
              <Typography children = {items.criteriaName}
              sx = {{
                color: "#DEDEDE",
                fontSize: "0.9em",
                fontWeight: "600",
              ...
              <Typography children = {items.criteriaPoints}
              sx = {{
                color: "#007FFF",
                fontSize: "0.9em",
                fontWeight: "600",
            ...
            {items.attributes.map(function(items2, index) {
              ...
              sx = {{
                ...
                <Typography children = {items2.attributeName}
                sx = {{
                  color: "#DEDEDE",
                  fontSize: "0.8em",
                  fontWeight: "500",
        ...
        sx = {{
          ...
          <Button variant = "contained" children = "Apply Score" onClick = {handleCreateApplyScore}
          sx = {{
            fontSize: "0.8em",
            fontWeight: "600",
            boxShadow: "none",
