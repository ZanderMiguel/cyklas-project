...
const dataTop = [
  {
    avatar: (
      <Avatar
        src="https://frozen-mountain-12506.herokuapp.com/static/zander.png9b5ce856e831cfe49e62f55fe3e9f9e0.png"
        alt="Avatar"
        sx={{ height: '2.5em' }}
      />
    ),
    memberName: 'Zander Miguel Mirador',
    points: '13 points',
    label: '1st place',
    ribbon: (
  ...
  },
  {
    ...
    memberName: 'Cedric Hiquiana',
    points: '8 points',
    label: '2nd place',
    ribbon: (
      <Tooltip title="Silver" placement="top">
  ...
  },
  {
    ...
    memberName: 'Charles Rellama',
    points: '5 points',
    label: '3rd place',
    ribbon: (
      <Tooltip title="Bronze" placement="top">
        ...
        >
          ...
          >
            <Tooltip title="Quiz ended" placement="bottom">
              <CheckCircleOutlined
                sx={{ color: '#39BA45', fontSize: '4.5em' }}
              />
            </Tooltip>
            ...
            >
              ...
              >
                ...
                <Typography
                  children="Overall Points: 13 points"
                  sx={{
                    color: 'white',
                    fontSize: '1em',
                    fontWeight: '500',
