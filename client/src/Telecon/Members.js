...
import { Box, Typography, Input, IconButton, Avatar, Tooltip } from "@mui/material";
import { PeopleAlt, Search, KeyboardVoiceOutlined, MicOffOutlined } from "@mui/icons-material";
  ...
  return (
    ...
    style = {{ 
      ...
      <Box
        ...
        <Input variant="standard" placeholder="Search member..." disableUnderline
          sx={{
          width: '100%',
          backgroundColor: 'transparent',
          fontSize: '0.8em',
      ...
      sx = {{
        ...
        sx = {{
          ...
          <Typography children = "Tom Holland" 
          sx = {{
            color: "white",
            fontSize: "0.7em",
            fontWeight: "500",
          ...
          <Typography children = "Meeting Host" 
          sx = {{
            color: "#DEDEDE",
            fontSize: "0.1em",
            fontWeight: "500",
        ...
        sx = {{
          ...
          <Box
            sx = { {
              ...
              <MicOffOutlined sx = {{ fontSize: "1.2em", color: "#DEDEDE" }}/>          
          </Box>
        </Tooltip>
        </Box>
        )
