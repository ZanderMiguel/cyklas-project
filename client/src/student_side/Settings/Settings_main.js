    ...
    <Container maxWidth="lg">
      <Grid container sx={designs.SettingsContainer_GridContainer_Style}>
            ...
            <List sx={designs.List_Style}>
              ...
              >
                ...
                <ListItemText sx={designs.ListItemText_Style}>
                  <Typography noWrap sx={designs.Profile_Typography_Style}>
                    Profile
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              >
                ...
                <ListItemText sx={designs.ListItemText_Style}>
                  <Typography noWrap sx={designs.Account_Typography_Style}>
                    Account
                  </Typography>
                </ListItemText>
              </ListItem>
        ...
        <Grid
          ...
          md={9}
          xs={12}
          sx={designs.RightContainer_GridItem_Style}
        >
          {view ? (
            <PersonalInformation_layout />
          ) : (
            <AccountInformation_layout />
          )}
        </Grid>
      </Grid>
    </Container>
