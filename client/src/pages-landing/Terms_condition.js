  ...
  return (
    ...
    >
      <p style={{ padding: '1em' }}>
        ...
        <br />
        <br />
        Bilibid Viejo Street, Quiapo Manila., Philippines By accessing this
        website, we assume you accept these terms of service in full. Do not
        ...
        <br />
        <br />
        <Typography variant="h5" children="Cookies" />
        <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="License" />
        <br />
        ...
        You must not:
        <br />
        1. Republish material from www.cycklas.com <br /> 2. Sell, rent or
        sub-license material from www.cycklas.com <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="User Comments" />
        <br />
        1. This Agreement shall begin on the date hereof. <br />
        <br /> 2. Certain parts of this website offer the opportunity for users
        ...
        <br />
        <br />
        <Typography variant="h5" children="Hyperlinking to our Content" />
        <br />
        ...
        <br />
        <br />
        2. These organizations may link to our home page, to publications or to
        ...
        Cycrowd; and (d) where the link is in the context of general resource
        ...
        <br />
        <br />
        <Typography variant="h5" children="Iframes" />
        <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="Content Liability" />
        <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="Reservation of Rights" />
        <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="Removal of links from our website" />
        <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="Disclaimer" />
        <br />
        ...
        <br />
        <br />
        <Typography variant="h5" children="Credit & Contact Information" />
        <br />
