...
import { Grid, Box, Typography, Divider, FormControl, RadioGroup, Radio, FormControlLabel } from "@mui/material";
...
function EvaluationTable() {
  ...
  const dataAttributes = [
    ...
    {
        attribute: "Communication (language, choice of words, grammar and influency)",
        choices: 
        <FormControl>
        <RadioGroup row name="row-radio-buttons-group">
    ...
    {
        attribute: "Aroused students' interests and encourages them for participation",
        choices: 
        <FormControl>
        <RadioGroup row name="row-radio-buttons-group">
    ...
    {
        attribute: "Used words and expressions within the student level of understanding",
        choices: 
        <FormControl>
        <RadioGroup row name="row-radio-buttons-group">
    ...
    {
        attribute: "Was there any element of creativity (by way of certain examples)",
        choices: 
        <FormControl>
        <RadioGroup row name="row-radio-buttons-group">
    ...
    sx = {{
        ...
        sx = {{
            ...
            sx = {{
                ...
                <Typography children = "Attributes & Performances"
                sx = {{
                    color: "white",
            ...
            {dataAttributes.map(function(items, index) {
                return (
                    ...
                    sx = {{
                        ...
                        <Typography children = {items.attribute}
                        sx = {{
                            color: "#3F3D56",
                            fontSize: "0.8em",
                            fontWeight: "500",
