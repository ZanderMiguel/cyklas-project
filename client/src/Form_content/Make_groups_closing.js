...
import { ArrowCircleRightOutlined, Send } from '@mui/icons-material';
...
function Make_groups_closing({ open, close, maxWidth }) {
      ...
      >
        <Grid container sx={{ padding: '0em 2em' }}>
          <Grid item xs={12}>
            ...
            >
              All groups will close in (30) seconds.
            </Typography>
                ...
                {dataGroup.map((items, index) => {
                  return (
                    ...
                    >
                      ...
                      >
                        <Tooltip
                          title="Join your students in their groupings"
                          placement="top"
                        >
                          <Button
                            variant="contained"
...
export default Make_groups_closing;
