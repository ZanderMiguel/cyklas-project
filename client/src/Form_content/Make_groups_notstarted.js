...
import { AddCircle, AddCircleOutline, BorderColorOutlined, DeleteOutlined, MoreVert, SettingsBackupRestore } from "@mui/icons-material";
...
function Make_groups_notstarted({ open, close, maxWidth }) {
    ...
    const [opendialogGroupsStarting, setOpenDialogGroupsStarting] = useState(false);
