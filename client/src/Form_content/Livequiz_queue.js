...
import { Check, VideocamOutlined, VideocamOffOutlined, Extension } from "@mui/icons-material";
...
const dataStudents = [
    {
        ...
        cameraStatus: <VideocamOutlined sx = {{ color: "#615F79", fontSize: "1.5em" }}/>
    },
    {
        avatar: <Avatar src = {AvatarIcon} sx = {{ marginRight: "0.5em" }}/>,
    ...
    },
    {
        ...
        userType: "Student",
        courseYearSec: "BSCS 3A",
        cameraStatus: <VideocamOffOutlined sx = {{ color: "#615F79", fontSize: "1.5em" }}/>
    },
    {
        avatar: <Avatar src = {AvatarIcon} sx = {{ marginRight: "0.5em" }}/>,
  ...
  return (
    <div>
      <Dialogform open={open} close={close} maxWidth={maxWidth} 
        btn={
          <Button variant="contained" startIcon = {<Extension/>} sx = {{ 
        ...
        <Typography sx = {{
          ...
          <Grid item xs = {12}>
            <Box sx = {{ height: "auto", width: "100%", display: "flex", padding: "0.5em 0em", marginBottom: "0.3em" }}>
                ...
                <Box sx = {{ width: "auto", height: "relative", display: "flex", justifyContent: "center", alignItems: "center", gap: "0.3em" }}>
                ...
                <Box sx = {{ height: "relative", width: "auto", display: "flex", justifyContent: "center", alignItems: "center" }}>
