...
import { Snackbar, Button, Box, Typography, IconButton, Slide } from "@mui/material";
    ...
    <div>
        ...
        anchorOrigin = {{
            ...
            <Box sx = {{ 
                ...
                <Typography children = "Link Copied!" 
                sx = {{
                    color: "white",
                    fontWeight: "600",
                    fontSize: "0.8em",
                ...
                <IconButton sx = {{ width: "auto", height: "auto", padding: "none" }} onClick = {handleClose}>
