...
function Groups_movemember({ open, close, maxWidth }) {
  return (
      <>
        ...
        <Grid container sx = {{ height: "auto", padding: "0em 2em" }}>
          <Grid item xs = {12}>
                ...
                {dataGroups.map(function(items, index) {
                    return (
                        <>
                        <Box key = {index} sx = {{ padding: "0.5em 1.5em", borderRadius: "0.3em", margin: "0.5em 0em", width: "relative", height: "auto", display: "flex", "&: hover": { cursor: "pointer", borderRadius: "0.3em", border: "1px solid #DBDBDB", backgroundColor: "#FCFCFC" } }}>
                        ...
                        {items.children.map((items2, index) => {
                                    return (
                                        <Box key = {index} sx = {{ padding: "0.2em 1em 0.2em 1.5em", borderRadius: "0.3em", width: "relative", height: "auto", display: "flex", gap: "0.5em" }}>
                                        {items2.avatar}
...
export default Groups_movemember;
